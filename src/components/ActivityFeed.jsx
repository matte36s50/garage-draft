...
export default function ActivityFeed({ supabase, leagueId, limit = 15 }) {
  ...
  return (
    <div className="bg-slate-800 rounded-lg p-6 border border-slate-700">
      <h3 className="text-lg font-bold mb-4 text-teal-400">Live Activity</h3>
...
function ActivityItem({ activity }) {
  const getActivityIcon = (type) => {
    switch (type) {
      case 'big_gain':
        return (
          <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-teal-500/20 text-teal-400">
      ...
      case 'car_added':
        return (
          <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-slate-700 text-slate-300">
      ...
      default:
        return (
          <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-slate-700 text-slate-400">
